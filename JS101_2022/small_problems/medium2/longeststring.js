...
Input: a string with multiple sentences
Output: the longest string based on how many words are in the string

Rules:

the longest sentence is deliminated by the one with the most words
...
given a string
declare the longestSentence variable
seperate the string into sentences
  using regex split based on [!.?] which are all seperators of sentences
  split each sentence into words
count the number of words in each sentence
  iterate through each sentence
    declare the numOfWords variable
    iterate through each word in a sentence
    if the element seperated is a word
      add one to numOfWords
return the sentence

let sentenceArr = string.match(/--|[a-z]+[.!?,]*//* gi);
____________________________________
Code
*/
